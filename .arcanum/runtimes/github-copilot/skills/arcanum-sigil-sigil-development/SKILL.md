...
description: Run the installed Arcanum sigil sigil-development from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil sigil-development using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/sigil-development/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/sigil-development/README.md when it exists.
