...
description: Run the installed Arcanum sigil observability-setup from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil observability-setup using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/observability-setup/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/observability-setup/README.md when it exists.
