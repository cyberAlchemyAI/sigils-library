...
description: Run the installed Arcanum sigil feature-glossary from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil feature-glossary using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/feature-glossary/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/feature-glossary/README.md when it exists.
