...
description: Run the installed Arcanum sigil sigil-runtime-installer from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil sigil-runtime-installer using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/sigil-runtime-installer/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/sigil-runtime-installer/README.md when it exists.
