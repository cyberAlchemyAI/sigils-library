...
description: Run the installed Arcanum sigil definitions-governance from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil definitions-governance using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/definitions-governance/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/definitions-governance/README.md when it exists.
