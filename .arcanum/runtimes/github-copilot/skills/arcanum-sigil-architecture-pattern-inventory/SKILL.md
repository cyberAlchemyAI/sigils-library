...
description: Run the installed Arcanum sigil architecture-pattern-inventory from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil architecture-pattern-inventory using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/architecture-pattern-inventory/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/architecture-pattern-inventory/README.md when it exists.
