...
description: Run the installed Arcanum sigil ontology-vault from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil ontology-vault using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/ontology-vault/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/ontology-vault/README.md when it exists.
