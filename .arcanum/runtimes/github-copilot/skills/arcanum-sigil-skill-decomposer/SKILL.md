...
description: Run the installed Arcanum sigil skill-decomposer from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil skill-decomposer using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/skill-decomposer/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/skill-decomposer/README.md when it exists.
