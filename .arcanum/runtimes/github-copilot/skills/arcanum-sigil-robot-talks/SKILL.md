...
description: Run the installed Arcanum sigil robot-talks from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil robot-talks using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/robot-talks/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/robot-talks/README.md when it exists.
