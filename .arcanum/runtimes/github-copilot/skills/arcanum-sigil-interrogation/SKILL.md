---
name: arcanum-sigil-interrogation
description: Run the installed Arcanum sigil structured-interview-kits from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil structured-interview-kits using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/structured-interview-kits/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/structured-interview-kits/README.md when it exists.
