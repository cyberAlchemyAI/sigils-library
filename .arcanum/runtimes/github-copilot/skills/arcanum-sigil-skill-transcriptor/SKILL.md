...
description: Run the installed Arcanum sigil skill-transcriptor from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil skill-transcriptor using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/skill-transcriptor/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/skill-transcriptor/README.md when it exists.
