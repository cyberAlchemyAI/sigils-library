...
description: Run the installed Arcanum spell arcanum-bootstrap from runtime-local contract files.
...
<objective>
Run the installed Arcanum spell arcanum-bootstrap using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/spells/arcanum-bootstrap/README.md.
