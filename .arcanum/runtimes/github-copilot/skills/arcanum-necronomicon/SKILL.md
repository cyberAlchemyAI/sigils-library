...
description: Run the installed Arcanum necronomicon ontology-harness from runtime-local contract files.
...
<objective>
Run the installed Arcanum necronomicon ontology-harness using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/spells/ontology-harness/README.md.
