...
description: Run the installed Arcanum spell discovery-to-inventory from runtime-local contract files.
...
<objective>
Run the installed Arcanum spell discovery-to-inventory using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/spells/discovery-to-inventory/README.md.
