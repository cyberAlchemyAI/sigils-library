...
description: Run the installed Arcanum sigil residuality-spec from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil residuality-spec using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/residuality-spec/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/residuality-spec/README.md when it exists.
