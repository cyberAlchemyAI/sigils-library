...
description: Run the installed Arcanum sigil scope-interview from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil scope-interview using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/scope-interview/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/scope-interview/README.md when it exists.
