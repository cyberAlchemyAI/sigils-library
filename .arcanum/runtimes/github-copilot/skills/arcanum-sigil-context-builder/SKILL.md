...
description: Run the installed Arcanum sigil context-builder from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil context-builder using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/context-builder/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/context-builder/README.md when it exists.
