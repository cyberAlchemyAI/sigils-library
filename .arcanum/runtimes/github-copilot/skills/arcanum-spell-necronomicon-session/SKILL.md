...
description: Run the installed Arcanum spell necronomicon-session from runtime-local contract files.
...
<objective>
Run the installed Arcanum spell necronomicon-session using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/spells/necronomicon-session/README.md.
