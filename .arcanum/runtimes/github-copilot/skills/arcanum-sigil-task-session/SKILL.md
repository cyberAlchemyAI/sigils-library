...
description: Run the installed Arcanum sigil task-session from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil task-session using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/task-session/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/task-session/README.md when it exists.
