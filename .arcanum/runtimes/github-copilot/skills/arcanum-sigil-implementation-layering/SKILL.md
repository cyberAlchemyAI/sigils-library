...
description: Run the installed Arcanum sigil implementation-layering from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil implementation-layering using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/implementation-layering/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/implementation-layering/README.md when it exists.
