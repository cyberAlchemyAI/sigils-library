...
description: Run the installed Arcanum spell invoke from runtime-local contract files.
...
<objective>
Run the installed Arcanum spell invoke using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/spells/invoke/README.md.
