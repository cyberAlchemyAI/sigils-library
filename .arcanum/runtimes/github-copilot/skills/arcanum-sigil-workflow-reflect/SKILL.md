...
description: Run the installed Arcanum sigil workflow-reflect from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil workflow-reflect using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/workflow-reflect/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/workflow-reflect/README.md when it exists.
