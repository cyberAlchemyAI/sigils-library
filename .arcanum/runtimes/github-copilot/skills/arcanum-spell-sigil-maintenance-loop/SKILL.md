...
description: Run the installed Arcanum spell sigil-maintenance-loop from runtime-local contract files.
...
<objective>
Run the installed Arcanum spell sigil-maintenance-loop using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/spells/sigil-maintenance-loop/README.md.
