...
description: Run the installed Arcanum sigil spellcraft from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil spellcraft using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/spellcraft/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/spellcraft/README.md when it exists.
