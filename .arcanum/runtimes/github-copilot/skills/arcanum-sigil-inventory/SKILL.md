...
description: Run the installed Arcanum sigil inventory from runtime-local contract files.
...
<objective>
Run the installed Arcanum sigil inventory using runtime-local contract files.
</objective>
...
<process>
1. Read the runtime-local contract file at .arcanum/runtimes/github-copilot/sigils/inventory/SKILL.md.
2. For sigils, also read .arcanum/runtimes/github-copilot/sigils/inventory/README.md when it exists.
