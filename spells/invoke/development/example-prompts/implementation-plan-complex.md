# Invoke Example Prompt: implementation-plan-complex

## Invocation

```text
arcanum-spell-invoke Plan migration from legacy social feed storage to a privacy-aware feed service.
```
...
- Task ID: `implementation-plan-complex`
- Template target: `implementation-plan`
- Complexity: `complex`
- User request: Plan migration from legacy social feed storage to a privacy-aware feed service.
- Expected invoke use: Emit layered implementation plan with migrations, blockers, and wave boundaries.
...
```text
arcanum/spells/invoke/development/example-outputs/implementation-plan-complex.output.md
```
