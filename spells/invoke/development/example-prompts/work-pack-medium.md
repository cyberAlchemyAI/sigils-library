# Invoke Example Prompt: work-pack-medium

## Invocation

```text
arcanum-spell-invoke Plan ecommerce checkout readiness with payment, inventory, order history, and support handoff tasks.
```
...
- Task ID: `work-pack-medium`
- Template target: `work-pack`
- Complexity: `medium`
- User request: Plan ecommerce checkout readiness with payment, inventory, order history, and support handoff tasks.
- Expected invoke use: Emit split-ready work-pack with gates and blockers.
...
```text
arcanum/spells/invoke/development/example-outputs/work-pack-medium.output.md
```
