# Invoke Example Prompt: implementation-layering-medium

## Invocation

```text
arcanum-spell-invoke Layer ecommerce checkout changes across payment authorization, inventory holds, refund state, and rollout gates.
```
...
- Task ID: `implementation-layering-medium`
- Template target: `implementation-layering`
- Complexity: `medium`
- User request: Layer ecommerce checkout changes across payment authorization, inventory holds, refund state, and rollout gates.
- Expected invoke use: Emit layer boundaries, deferred scope, promotion evidence, and risks.
...
```text
arcanum/spells/invoke/development/example-outputs/implementation-layering-medium.output.md
```
