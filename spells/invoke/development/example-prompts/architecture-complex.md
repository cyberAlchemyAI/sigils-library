# Invoke Example Prompt: architecture-complex

## Invocation

```text
arcanum-spell-invoke Design a Facebook-like social platform architecture with feed, graph, privacy, moderation, notifications, and observability.
```
...
- Task ID: `architecture-complex`
- Template target: `architecture`
- Complexity: `complex`
- User request: Design a Facebook-like social platform architecture with feed, graph, privacy, moderation, notifications, and observability.
- Expected invoke use: Emit six-view architecture with dependency/interface map and risks.
...
```text
arcanum/spells/invoke/development/example-outputs/architecture-complex.output.md
```
