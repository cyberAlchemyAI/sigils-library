# Invoke Example Prompt: implementation-layering-low

## Invocation

```text
arcanum-spell-invoke Layer a small search filter feature into L0 proof, L1 hardening, and deferred analytics.
```
...
- Task ID: `implementation-layering-low`
- Template target: `implementation-layering`
- Complexity: `low`
- User request: Layer a small search filter feature into L0 proof, L1 hardening, and deferred analytics.
- Expected invoke use: Emit a compact layer decision table.
...
```text
arcanum/spells/invoke/development/example-outputs/implementation-layering-low.output.md
```
