# Invoke Example Prompt: research-medium

## Invocation

```text
arcanum-spell-invoke Investigate whether a Facebook-like feed should rank by recency, engagement, or follow graph signals.
```
...
- Task ID: `research-medium`
- Template target: `research`
- Complexity: `medium`
- User request: Investigate whether a Facebook-like feed should rank by recency, engagement, or follow graph signals.
- Expected invoke use: Emit claim status, contradictions, and architecture decision inputs.
...
```text
arcanum/spells/invoke/development/example-outputs/research-medium.output.md
```
