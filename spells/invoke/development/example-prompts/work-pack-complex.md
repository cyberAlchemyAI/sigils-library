# Invoke Example Prompt: work-pack-complex

## Invocation

```text
arcanum-spell-invoke Plan a Facebook-like notification system across mobile, web, ranking, privacy, and migration dependencies.
```
...
- Task ID: `work-pack-complex`
- Template target: `work-pack`
- Complexity: `complex`
- User request: Plan a Facebook-like notification system across mobile, web, ranking, privacy, and migration dependencies.
- Expected invoke use: Emit split work-pack with waves, shared context, blockers, and execution-pack reference.
...
```text
arcanum/spells/invoke/development/example-outputs/work-pack-complex.output.md
```
