# Invoke Example Prompt: ux-plan-complex

## Invocation

```text
arcanum-spell-invoke Plan Facebook-like content moderation UX across reporting, review queues, appeal states, notifications, and accessibility.
```
...
- Task ID: `ux-plan-complex`
- Template target: `ux-plan`
- Complexity: `complex`
- User request: Plan Facebook-like content moderation UX across reporting, review queues, appeal states, notifications, and accessibility.
- Expected invoke use: Emit UX plan with surface map, state model, content rules, and risk handoffs.
...
```text
arcanum/spells/invoke/development/example-outputs/ux-plan-complex.output.md
```
