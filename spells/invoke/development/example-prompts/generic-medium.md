# Invoke Example Prompt: generic-medium

## Invocation

```text
arcanum-spell-invoke Turn an ecommerce returns workflow idea into scope, actors, acceptance criteria, and open decisions.
```
...
- Task ID: `generic-medium`
- Template target: `generic`
- Complexity: `medium`
- User request: Turn an ecommerce returns workflow idea into scope, actors, acceptance criteria, and open decisions.
- Expected invoke use: Emit generic spec-like artifact with gaps and route recommendation.
...
```text
arcanum/spells/invoke/development/example-outputs/generic-medium.output.md
```
