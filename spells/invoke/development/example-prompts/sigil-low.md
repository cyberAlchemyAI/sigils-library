# Invoke Example Prompt: sigil-low

## Invocation

```text
arcanum-spell-invoke Create a deterministic CSV column normalization sigil.
```
...
- Complexity: `low`
- User request: Create a deterministic CSV column normalization sigil.
- Expected invoke use: Emit sigil-development handoff with inputs, outputs, and quality bar.
...
```text
arcanum/spells/invoke/development/example-outputs/sigil-low.output.md
```
