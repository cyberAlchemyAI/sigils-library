# Invoke Example Prompt: spell-low

## Invocation

```text
arcanum-spell-invoke Create a daily research-summary spell that composes inventory and context-builder.
```
...
- Complexity: `low`
- User request: Create a daily research-summary spell that composes inventory and context-builder.
- Expected invoke use: Emit spellcraft handoff context.
...
```text
arcanum/spells/invoke/development/example-outputs/spell-low.output.md
```
