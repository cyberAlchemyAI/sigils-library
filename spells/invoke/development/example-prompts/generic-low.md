# Invoke Example Prompt: generic-low

## Invocation

```text
arcanum-spell-invoke Clarify a vague request to organize a team's deployment checklist.
```
...
- Complexity: `low`
- User request: Clarify a vague request to organize a team's deployment checklist.
- Expected invoke use: Emit neutral define artifact and next route.
...
```text
arcanum/spells/invoke/development/example-outputs/generic-low.output.md
```
