# Invoke Example Prompt: generic-complex

## Invocation

```text
arcanum-spell-invoke Frame a multi-tenant marketplace expansion where business, architecture, UX, and planning needs are unclear.
```
...
- Task ID: `generic-complex`
- Template target: `generic`
- Complexity: `complex`
- User request: Frame a multi-tenant marketplace expansion where business, architecture, UX, and planning needs are unclear.
- Expected invoke use: Emit broad lifecycle baseline and route to research, architecture, or plan as needed.
...
```text
arcanum/spells/invoke/development/example-outputs/generic-complex.output.md
```
