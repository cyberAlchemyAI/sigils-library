# Invoke Example Prompt: module-formulae-low

## Invocation

```text
arcanum-spell-invoke Define a Mars sample catalog module with sample ID, source mission, curation state, and search notes.
```
...
- Task ID: `module-formulae-low`
- Template target: `module-formulae`
- Complexity: `low`
- User request: Define a Mars sample catalog module with sample ID, source mission, curation state, and search notes.
- Expected invoke use: Use discovery profile to emit module spec and glossary.
...
```text
arcanum/spells/invoke/development/example-outputs/module-formulae-low.output.md
```
