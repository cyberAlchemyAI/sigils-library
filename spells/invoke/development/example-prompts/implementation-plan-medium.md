# Invoke Example Prompt: implementation-plan-medium

## Invocation

```text
arcanum-spell-invoke Plan ecommerce checkout refactor from approved architecture and glossary.
```
...
- Task ID: `implementation-plan-medium`
- Template target: `implementation-plan`
- Complexity: `medium`
- User request: Plan ecommerce checkout refactor from approved architecture and glossary.
- Expected invoke use: Emit staged implementation plan with source design refs and gates.
...
```text
arcanum/spells/invoke/development/example-outputs/implementation-plan-medium.output.md
```
