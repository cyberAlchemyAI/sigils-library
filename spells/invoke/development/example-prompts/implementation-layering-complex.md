# Invoke Example Prompt: implementation-layering-complex

## Invocation

```text
arcanum-spell-invoke Layer a social platform feed rewrite across ranking, privacy enforcement, moderation, migrations, and staged release.
```
...
- Task ID: `implementation-layering-complex`
- Template target: `implementation-layering`
- Complexity: `complex`
- User request: Layer a social platform feed rewrite across ranking, privacy enforcement, moderation, migrations, and staged release.
- Expected invoke use: Emit multi-layer promotion decisions with irreversible-risk callouts.
...
```text
arcanum/spells/invoke/development/example-outputs/implementation-layering-complex.output.md
```
