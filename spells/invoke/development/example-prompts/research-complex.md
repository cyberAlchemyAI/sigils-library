# Invoke Example Prompt: research-complex

## Invocation

```text
arcanum-spell-invoke Research Mars habitat dust contamination risks across mission notes, sensor reports, and operational constraints.
```
...
- Task ID: `research-complex`
- Template target: `research`
- Complexity: `complex`
- User request: Research Mars habitat dust contamination risks across mission notes, sensor reports, and operational constraints.
- Expected invoke use: Emit multi-source research brief with unresolved claims and decision gates.
...
```text
arcanum/spells/invoke/development/example-outputs/research-complex.output.md
```
