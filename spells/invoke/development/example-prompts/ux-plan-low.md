# Invoke Example Prompt: ux-plan-low

## Invocation

```text
arcanum-spell-invoke Plan a settings form for notification preferences.
```
...
- Complexity: `low`
- User request: Plan a settings form for notification preferences.
- Expected invoke use: Emit UX plan with actors, states, and accessibility checks.
...
```text
arcanum/spells/invoke/development/example-outputs/ux-plan-low.output.md
```
