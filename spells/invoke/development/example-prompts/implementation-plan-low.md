# Invoke Example Prompt: implementation-plan-low

## Invocation

```text
arcanum-spell-invoke Plan implementation for adding saved filters to a reporting screen.
```
...
- Task ID: `implementation-plan-low`
- Template target: `implementation-plan`
- Complexity: `low`
- User request: Plan implementation for adding saved filters to a reporting screen.
- Expected invoke use: Emit small delivery slice and validation checklist.
...
```text
arcanum/spells/invoke/development/example-outputs/implementation-plan-low.output.md
```
