# Invoke Example Prompt: spell-complex

## Invocation

```text
arcanum-spell-invoke Create a full lifecycle product-discovery spell for a Facebook-like platform that routes define, research, architecture, planning, and validation.
```
...
- Task ID: `spell-complex`
- Template target: `spell`
- Complexity: `complex`
- User request: Create a full lifecycle product-discovery spell for a Facebook-like platform that routes define, research, architecture, planning, and validation.
- Expected invoke use: Emit spellcraft handoff with authority boundaries and unresolved lifecycle decisions.
...
```text
arcanum/spells/invoke/development/example-outputs/spell-complex.output.md
```
