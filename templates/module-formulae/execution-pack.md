...
| Task ID | Goal | Complexity | Waves | Gate Status | Status |
| --- | --- | --- | --- | --- | --- |
| TASK-A | {goal summary} | medium | W1, W2 | ready | not-started |
| TASK-VERIFY | Completion verification | high | W3+ | ready-after-implementation | not-started |
| TASK-AUDIT-ALIGNMENT | Contract alignment audit | high | W3+ | ready-after-mutation | not-started |
| TASK-AUDIT-LAYERING | Boundary layering audit | high | W3+ | ready-after-mutation | not-started |
| TASK-SIGNAL-ALIGNMENT | Alignment signal obligation | medium | W3+ | ready-after-docs | not-started |
| TASK-SIGNAL-LAYERING | Layering signal obligation | medium | W3+ | ready-after-docs | not-started |
